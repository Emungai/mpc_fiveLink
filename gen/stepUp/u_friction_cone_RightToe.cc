 ...
 * Tue 19 Nov 2019 21:07:37 GMT-05:00
 */
...
{
  double t3116;
  t3116 = 0.7071065623731627*var1[2]*var2[0];
  p_output1[0]=var1[2];
  p_output1[1]=t3116 + var1[0];
  p_output1[2]=t3116 - 1.*var1[0];
  p_output1[3]=t3116 + var1[1];
  p_output1[4]=t3116 - 1.*var1[1];
}
