...
% Add constraint for between DS domains
selected = ones(10,1);
BezierSymmetry_cstr = NlpFunction('Name','BezierSymmetry',...
    ...
    'DepVariables',[nlp.Phase(1).OptVarTable.atime(end), nlp.Phase(5).OptVarTable.atime(1)],...
    'AuxData',selected);
...
BezierSymmetry_cstr = NlpFunction('Name','BezierSymmetry',...
    ...
    'Type','Linear',...
    'SymFun',BezierSymmetry,...
    'DepVariables',[nlp.Phase(3).OptVarTable.atime(end), nlp.Phase(7).OptVarTable.atime(1)],...
    'AuxData',selected);

addConstraint(nlp.Phase(3), 'BezierSymmetry', 'last', BezierSymmetry_cstr);
