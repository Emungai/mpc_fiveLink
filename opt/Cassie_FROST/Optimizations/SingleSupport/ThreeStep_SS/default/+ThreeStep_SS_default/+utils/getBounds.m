...
bounds.LeftStance1.params.pLeftToeBottom.lb = [-10;-10;-10;0;-pi/2];
bounds.LeftStance1.params.pLeftToeBottom.ub = [10;10;10;0;-pi/2];
bounds.LeftStance1.params.pLeftToeBottom.x0 = [0;0;0;0;-pi/2];
...
bounds.LeftStance1.params.ptime.lb = [bounds.RightStance1.time.tf.lb, bounds.RightStance1.time.t0.lb];
bounds.LeftStance1.params.ptime.ub = [bounds.RightStance1.time.tf.ub, bounds.RightStance1.time.t0.ub];
bounds.LeftStance1.params.ptime.x0 = [bounds.RightStance1.time.t0.x0, bounds.RightStance1.time.tf.x0];
