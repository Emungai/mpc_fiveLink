...
model_bounds.states.x.lb([7,8,14,15]) = deg2rad(-3);
model_bounds.states.x.ub([7,8,14,15]) = deg2rad(3);
...
model_bounds.average_velocity.lb = [0.5,0.2];
model_bounds.average_velocity.ub = [0.5,0.2];
