function left_stance_down_2(nlp, bounds, varargin)
    % Extract Plant
    domain = nlp.Plant;
    ...
    %% Foot hit ground
    p_left_toe = getCartesianPosition(nlp.Plant, nlp.Plant.ContactPoints.RightToeBottom);
    expr = p_left_toe(3);
    swingFootHeight = SymFunction(['u_rightToeHeight_', domain.Name], expr, {domain.States.x});    
    ...
    if strcmp(bounds.shared.convergance, 'constraint')
        % Torque Cost
