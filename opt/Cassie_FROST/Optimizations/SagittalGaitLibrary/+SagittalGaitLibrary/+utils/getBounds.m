...
bounds.RightStance.time.tf.ub = 0.5;
bounds.RightStance.time.tf.x0 = 0.5;

bounds.RightStance.time.duration.lb = 0.5;
bounds.RightStance.time.duration.ub = 0.5;
...
bounds.LeftStance.time.tf.ub = 0.5;
bounds.LeftStance.time.tf.x0 = 0.5;

bounds.LeftStance.time.duration.lb = 0.5;
bounds.LeftStance.time.duration.ub = 0.5;
bounds.LeftStance.time.duration.x0 = 0.5;
