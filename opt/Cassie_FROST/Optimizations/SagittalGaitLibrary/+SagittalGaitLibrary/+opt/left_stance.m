function left_stance(nlp, bounds, varargin)
    ...
    addNodeConstraint(nlp, cassie.constraints.step_height(nlp), ...
        {'x'}, ceil(nlp.NumNode/2), bounds.foot_clearance.lb, bounds.foot_clearance.ub, 'Nonlinear');
    
    %% Stair Clearance
%     addNodeConstraint(nlp, cassie.constraints.stair_clearance(nlp), ...
%        {'x'}, 'all', -0.00, Inf, 'Nonlinear',{zeros(1,4)});
