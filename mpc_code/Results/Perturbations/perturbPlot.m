...
grid on; set(gca,'FontSize',sz)
legend({'0.05 IC','0.04 IC','0.06 IC'});
set(legend,...
...
legend({'0.05 IC','0.04 IC','0.06 IC'},'location','best');
set(gcf,'color','w');