 ...
 * Tue 3 Dec 2019 15:23:19 GMT-05:00
 */
...
{
  double t2011;
  t2011 = 0.7071065623731627*var1[2]*var2[0];
  p_output1[0]=var1[2];
  p_output1[1]=t2011 + var1[0];
  p_output1[2]=t2011 - 1.*var1[0];
  p_output1[3]=t2011 + var1[1];
  p_output1[4]=t2011 - 1.*var1[1];
}
