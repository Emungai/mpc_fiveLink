function DS2_constraints(nlp, bounds, varargin)
%% virtual constraints
args=varargin{1};
x_step=args.x_step;
y_step=args.y_step;
...
% 
% feetPosY_fun=SymFunction(['feetPosInit',system.Name],leftFoot(2),{system.States.x});
% lb = bounds.constrBounds.feetPosY.lb;
% ub = bounds.constrBounds.feetPosY.ub;
% addNodeConstraint(nlp, feetPosY_fun, {'x'}, 'all', lb, ub, 'NonLinear');
