 ...
 %
 % Contact: Left Toe
function domain = LeftStanceLand(model, load_path,h_step)
    ...
    x_nsf = UnilateralConstraint(domain,p_nsf(2)-h_step,'rightFootHeight','x');
    domain = addEvent(domain, x_nsf);
